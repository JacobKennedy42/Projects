...
public class Tile {
	...
	public static final int TILE_WIDTH = 90, TILE_HEIGHT = (int)(TILE_WIDTH * (Math.sqrt(3)/2))+1, TILE_GAP = TILE_WIDTH/10;
	...
	public void projectOnTo (Tile simulatedTile) {
		Mob copy = _mob == null ? null : _mob.makePreviewCopy();
		simulatedTile.setState(copy, _baseColor, _outlineColor, _onEnterEffect);
	}
