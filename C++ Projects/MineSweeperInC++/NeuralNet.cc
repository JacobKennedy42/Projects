...
static const int HIDDEN_SIZE = BOARD_SIZE * 2;//BOARD_SQRD*4;//BOARD_SQRD / 2;
...
static const double EP_MIN = .005;//.05;
...
static const double LEARN_RATE = .001;//.1;
